...
class WeatherViewModel: ObservableObject {
    ...
    let typhoonInfo: String = "A typhoon is a large storm with strong winds and heavy rain. When a typhoon passes, trees can fall and houses can collapse. That's why we need to evacuate to a safe place when a typhoon is coming. The situation where we need to evacuate for safety occurs when a typhoon is approaching. At this time, we may feel emotions such as ‘anxiety😱’, ‘fear😰’, and ‘worry😮‍💨’."
    ...
    func getWeather() {
        ...
        let typhoon = WeatherModel(name: "Typhoon🌪️", imageName: "Typhoon", information: typhoonInfo, musicName: "Typhoon")
